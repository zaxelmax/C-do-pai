...
{
    public void CarregaVetor(string[qntmax, 16] vetor, string[] index)
    {
        for (i = 0; i < qntmax; i++){
            for (j = 0; j < 16; j++){
                if (j < 7)
                ...
                {
                    Console.WriteLine("Informe o(a) {0} do item", index[i]);
    ...
    public void AlteraVetor(string[qntmax, 16] vetor, string[] index)
    {
    ...
    public int ConsultaVetor(){
        if (decisao == "CONSULTAR")
        {
            ...
            if (i != 16)
            {
                Console.WriteLine("{0}:::::::::{1}",index[i],vetor[i]);
            }else
            {
                for(i=0;i<16;i++)
                    {
                    Console.WriteLine("O {0} é:_________{1}",index[i],vetor[i]);
                    }
                }
            }
        }
